import { Button, Checkbox, Collapse, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, FormControlLabel, FormHelperText, InputLabel, Table, TableBody, TableCell, TableHead, TableRow } from '@material-ui/core';
    ...
    return (
      <div>
        ...
        <div className={this.props.classes.container}>
          ...
          <FormHelperText style={{ minWidth: Property.inputMinWidth }}>
            Export this project's data in a CSV format. Useful if you'd like to analyze your data yourself or move to another provider.
