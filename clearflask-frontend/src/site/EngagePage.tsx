...
export const transparencyTitle = 'Build a community around your product roadmap';
export const transparencyDescription = 'Whether you are starting out or have a product on the market, keep your users updated at every step. Let them be involved in your decision making and shape your product.';
