...
class PanelWithSearch extends Component<Props, State> {
    ...
    return (
      <div className={this.props.classes.container}>
        ...
        <Panel
          ...
          onClickTag={this.props.panel.enableSearchByTag !== false ? tagId => this.setState({overrideSearch: {...this.state.overrideSearch, filterTagIds: [tagId]}}) : undefined}
          onClickCategory={this.props.panel.enableSearchByCategory !== false ? categoryId => this.setState({overrideSearch: {...this.state.overrideSearch, filterCategoryIds: [categoryId]}}) : undefined}
          onClickStatus={this.props.panel.enableSearchByStatus !== false ? statusId => this.setState({overrideSearch: {...this.state.overrideSearch, filterStatusIds: [statusId]}}) : undefined}
        />
      </div>
    );
  }
...
}})(withStyles(styles, { withTheme: true })(PanelWithSearch));
