    ...
    private static Module module(Environment env) {
        return new AbstractModule() {
            ...
            protected void configure() {
                ...
                install(DynamoElasticMysqlAccountStore.module());
                install(DynamoElasticMysqlUserStore.module());
                install(DynamoTokenVerifyStore.module());
                install(DynamoElasticMysqlIdeaStore.module());
                install(DynamoDraftStore.module());
                install(DynamoNotificationStore.module());
                install(DynamoElasticMysqlCommentStore.module());
