...
public class JooqCommentRecord extends UpdatableRecordImpl<JooqCommentRecord> implements Record15<String, String, String, String, Long, Long, String, String, Boolean, Instant, Instant, String, Long, Long, Double> {
    ...
    /**
     * Setter for <code>comment.parentCommentIds</code>.
     */
    public void setParentcommentids(String value) {
        set(3, value);
    }

    /**
     * Getter for <code>comment.parentCommentIds</code>.
     */
    ...
    @Override
    public Row15<String, String, String, String, Long, Long, String, String, Boolean, Instant, Instant, String, Long, Long, Double> valuesRow() {
    ...
    public Field<String> field4() {
        return JooqComment.COMMENT.PARENTCOMMENTIDS;
    }
    ...
    @Override
    public JooqCommentRecord value4(String value) {
        setParentcommentids(value);
        return this;
    }
    ...
    @Override
    public JooqCommentRecord value6(Long value) {
    ...
    @Override
    public JooqCommentRecord value8(String value) {
        setAuthorname(value);
        return this;
    }

    @Override
    public JooqCommentRecord value9(Boolean value) {
    ...
    @Override
    public JooqCommentRecord value11(Instant value) {
        setEdited(value);
        return this;
    }

    @Override
    public JooqCommentRecord value12(String value) {
        setContent(value);
        return this;
    }
    ...
    @Override
    public JooqCommentRecord value14(Long value) {
        setDownvotes(value);
        return this;
    }

    @Override
    public JooqCommentRecord value15(Double value) {
        setScore(value);
        return this;
    }

    @Override
    public JooqCommentRecord values(String value1, String value2, String value3, String value4, Long value5, Long value6, String value7, String value8, Boolean value9, Instant value10, Instant value11, String value12, Long value13, Long value14, Double value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JooqCommentRecord(String projectid, String postid, String commentid, String parentcommentids, Long level, Long childcommentcount, String authoruserid, String authorname, Boolean authorismod, Instant created, Instant edited, String content, Long upvotes, Long downvotes, Double score) {
        super(JooqComment.COMMENT);

        setProjectid(projectid);
        setPostid(postid);
        setCommentid(commentid);
        setParentcommentids(parentcommentids);
        setLevel(level);
