...
public class JooqIdeaRecord extends UpdatableRecordImpl<JooqIdeaRecord> {
     ...
     */
    public JooqIdeaRecord(String projectid, String postid, String authoruserid, String authorname, Boolean authorismod, Instant created, Instant lastactivity, String title, String description, String response, String responseauthoruserid, String responseauthorname, String categoryid, String statusid, Long commentcount, Long childcommentcount, Long funded, Long funderscount, Long votevalue, Long voterscount, Double expressionsvalue, Double trendscore, String mergedtopostid, Double order) {
        super(JooqIdea.IDEA);
