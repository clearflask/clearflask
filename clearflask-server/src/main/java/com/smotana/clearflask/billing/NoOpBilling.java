...
public class NoOpBilling implements Billing {
    ...
    public static final ImmutableSet<String> NOOP_BILLED_PLAN_IDS = ImmutableSet.of(
            ...
            // a per-customer price override (KB slug flat-yearly-1). The handful of $0 comps were
            // normalized to base planid "flat-yearly" so this membership check routes them to NoOp.
            "flat-yearly");
