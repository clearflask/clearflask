...
aws s3 cp s3://clearflask-secret/clearflask-server-0.1.war /var/lib/tomcat/webapps/300clearflask/ROOT.war &
...
chmod go-rwx /var/lib/tomcat/webapps/300clearflask/ROOT.war
chown tomcat:tomcat /var/lib/tomcat/webapps/300clearflask/ROOT.war
