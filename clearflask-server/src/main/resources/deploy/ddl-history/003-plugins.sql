...
CREATE INDEX idx_comp_where ON notifications (effective_date, processing_state, processing_owner,
...
create index analytics_payment_auths_cdate_trid_crcy_status_rgroup_camount on analytics_payment_auths (created_date,
                                                                                                       tenant_record_id,
                                                                                                       currency,
                                                                                                       payment_transaction_status,
                                                                                                       report_group,
                                                                                                       converted_amount);
create index ap_auths_cdate_trid_crcy_status_rgroup_camount_pname_perror on analytics_payment_auths (created_date,
                                                                                                     tenant_record_id,
                                                                                                     currency,
                                                                                                     payment_transaction_status,
                                                                                                     report_group,
...
create index analytics_payment_captures_cdate_trid_crcy_status_rgroup_camount on analytics_payment_captures (created_date,
                                                                                                             tenant_record_id,
                                                                                                             currency,
                                                                                                             payment_transaction_status,
                                                                                                             report_group,
                                                                                                             converted_amount);
create index ap_captures_cdate_trid_crcy_status_rgroup_camount_pname_perror on analytics_payment_captures (created_date,
                                                                                                           tenant_record_id,
                                                                                                           currency,
                                                                                                           payment_transaction_status,
                                                                                                           report_group,
...
create index analytics_payment_prchses_cdate_trid_crcy_status_rgroup_camount on analytics_payment_purchases (created_date,
                                                                                                             tenant_record_id,
                                                                                                             currency,
                                                                                                             payment_transaction_status,
                                                                                                             report_group,
                                                                                                             converted_amount);
create index ap_prchses_cdate_trid_crcy_status_rgroup_camount_pname_perror on analytics_payment_purchases (created_date,
                                                                                                           tenant_record_id,
                                                                                                           currency,
                                                                                                           payment_transaction_status,
                                                                                                           report_group,
...
create index analytics_payment_refunds_cdate_trid_crcy_status_rgroup_camount on analytics_payment_refunds (created_date,
                                                                                                           tenant_record_id,
                                                                                                           currency,
                                                                                                           payment_transaction_status,
                                                                                                           report_group,
                                                                                                           converted_amount);
create index ap_refunds_cdate_trid_crcy_status_rgroup_camount_pname_perror on analytics_payment_refunds (created_date,
                                                                                                         tenant_record_id,
                                                                                                         currency,
                                                                                                         payment_transaction_status,
                                                                                                         report_group,
...
create index analytics_payment_credits_cdate_trid_crcy_status_rgroup_camount on analytics_payment_credits (created_date,
                                                                                                           tenant_record_id,
                                                                                                           currency,
                                                                                                           payment_transaction_status,
                                                                                                           report_group,
                                                                                                           converted_amount);
create index ap_credits_cdate_trid_crcy_status_rgroup_camount_pname_perror on analytics_payment_credits (created_date,
                                                                                                         tenant_record_id,
                                                                                                         currency,
                                                                                                         payment_transaction_status,
                                                                                                         report_group,
...
create index analytics_payment_cbacks_cdate_trid_crcy_status_rgroup_camount on analytics_payment_chargebacks (created_date,
                                                                                                              tenant_record_id,
                                                                                                              currency,
                                                                                                              payment_transaction_status,
                                                                                                              report_group,
                                                                                                              converted_amount);
create index ap_cbacks_cdate_trid_crcy_status_rgroup_camount_pname_perror on analytics_payment_chargebacks (created_date,
                                                                                                            tenant_record_id,
                                                                                                            currency,
                                                                                                            payment_transaction_status,
                                                                                                            report_group,
...
create index analytics_payment_voids_cdate_trid_crcy_status_rgroup_camount on analytics_payment_voids (created_date,
                                                                                                       tenant_record_id,
                                                                                                       currency,
                                                                                                       payment_transaction_status,
                                                                                                       report_group,
                                                                                                       converted_amount);
create index ap_voids_cdate_trid_crcy_status_rgroup_camount_pname_perror on analytics_payment_voids (created_date,
                                                                                                     tenant_record_id,
                                                                                                     currency,
                                                                                                     payment_transaction_status,
                                                                                                     report_group,
...
create index analytics_notifications_comp_where on analytics_notifications (effective_date, processing_state,
                                                                            processing_owner,
                                                                            processing_available_date);
...
create
or replace view v_system_report_notifications_per_queue_name as
select search_key2 as tenant_record_id
     , queue_name
...
create
or replace view v_system_report_control_tag_no_test as
select a1.tenant_record_id
     , a1.name as tag_name
...
where 1=1
  ...
  and a1.name IN ('OVERDUE_ENFORCEMENT_OFF'
    , 'AUTO_PAY_OFF'
    , 'AUTO_INVOICING_OFF'
    , 'MANUAL_PAY'
    , 'PARTNER')
...
create
or replace view v_system_report_payments as
...
create
or replace view v_system_report_payments_per_day as
select tenant_record_id
...
create
or replace view v_system_report_notifications_per_queue_name_late as
select search_key2 as tenant_record_id
     , queue_name  as label
     , count(*) as count
from notifications
...
create
or replace view v_report_invoice_credits_daily as
select aic.tenant_record_id
     , aic.currency
...
create
or replace view v_report_trial_starts_count_daily as
select ast.tenant_record_id
...
create
or replace view v_report_invoice_item_adjustments_daily as
select aiia.tenant_record_id
     , aiia.currency
...
create
or replace view v_report_invoice_adjustments_daily as
select aia.tenant_record_id
     , aia.currency
...
create
or replace view v_report_conversions_daily as
select ast.tenant_record_id
...
create
or replace view v_report_overdue_states_count_daily as
select aat.tenant_record_id
     , aat.state
     , date_format(cal.d, '%Y-%m-%d') as day
, count(1) as count
from
    calendar cal
    join analytics_account_transitions aat
on date_format(aat.start_date, '%Y-%m-%d')=date_format(cal.d, '%Y-%m-%d')
where 1=1
...
create
or replace view v_report_new_accounts_daily as
select aa.tenant_record_id
...
create table report_new_accounts_daily as
select *
from v_report_new_accounts_daily limit 0;
...
START TRANSACTION;
delete
from report_new_accounts_daily;
insert into report_new_accounts_daily
select *
from v_report_new_accounts_daily;
COMMIT;
...
create
or replace view v_report_active_by_product_term_monthly as
select tenant_record_id
     , cal.d as day
...
from
    analytics_subscription_transitions ast
    join calendar cal
on next_start_date < cal.d and (next_end_date > cal.d or next_end_date is null ) and (cal.d = last_day(cal.d) or cal.d = cast (date_format(now(), '%Y-%m-%d') as date))
where 1=1
  and event in ('START_ENTITLEMENT_BASE'
    , 'CHANGE_BASE'
    , 'SYSTEM_CHANGE_BASE')
...
create table report_active_by_product_term_monthly as
select *
from v_report_active_by_product_term_monthly limit 0;
...
START TRANSACTION;
delete
from report_active_by_product_term_monthly;
insert into report_active_by_product_term_monthly
select x.tenant_record_id
     , cal.d day
     , x.product_name
     , x.billing_period
     , x.count
from calendar cal
         join (select tenant_record_id
                    , last_day(day) day
                    , product_name
                    , billing_period
                    , count
               from v_report_active_by_product_term_monthly
               where 1 = 1) x on last_day(cal.d) = x.day
where 1 = 1
;
COMMIT;
...
create
or replace view v_report_chargebacks_daily as
select ac.tenant_record_id
...
create table report_chargebacks_daily as
select *
from v_report_chargebacks_daily limit 0;
...
START TRANSACTION;
delete
from report_chargebacks_daily;
insert into report_chargebacks_daily
select *
from v_report_chargebacks_daily;
COMMIT;
...
create
or replace view v_report_payments_total_daily_sub1 as
select ac.tenant_record_id
     , 'CAPTURE' as op
     , date_format(ac.created_date, '%Y-%m-%d') as day
, ac.currency
...
create
or replace view v_report_payments_total_daily as
select tenant_record_id
     , day
     , currency
     , sum (count) as count
...
create table report_payments_total_daily as
select *
from v_report_payments_total_daily limit 0;
...
START TRANSACTION;
delete
from report_payments_total_daily;
insert into report_payments_total_daily
select *
from v_report_payments_total_daily;
COMMIT;
...
create
or replace view v_report_payments_by_provider_sub1 as
SELECT a.plugin_name                                                                              as plugin_name
     ...
     , count(1)                                                                                   as total
     , sum(case
               when a.payment_transaction_status in ('UNKNOWN', 'PAYMENT_FAILURE', 'PLUGIN_FAILURE') then 1
...
FROM analytics_payment_auths a FORCE INDEX(analytics_payment_auths_created_date)
WHERE 1=1
  AND a.created_date
    >now() - interval '7' day
GROUP BY
...
SELECT a.plugin_name                                                                              as plugin_name
     ...
     , sum(case when a.payment_transaction_status = 'SUCCESS' then a.converted_amount else 0 end) as converted_amount
     , a.converted_currency
FROM analytics_payment_captures a FORCE INDEX(analytics_payment_captures_created_date)
WHERE 1=1
  AND a.created_date
    >now() - interval '7' day
GROUP BY
...
SELECT a.plugin_name                                                                              as plugin_name
     ...
     , sum(case when a.payment_transaction_status = 'SUCCESS' then a.converted_amount else 0 end) as converted_amount
     , a.converted_currency
FROM analytics_payment_chargebacks a FORCE INDEX(analytics_payment_chargebacks_created_date)
WHERE 1=1
  AND a.created_date
    >now() - interval '7' day
GROUP BY
...
SELECT a.plugin_name                                                                              as plugin_name
     ...
     , sum(case when a.payment_transaction_status = 'SUCCESS' then a.converted_amount else 0 end) as converted_amount
     , a.converted_currency
FROM analytics_payment_credits a FORCE INDEX(analytics_payment_credits_created_date)
WHERE 1=1
  AND a.created_date
    >now() - interval '7' day
GROUP BY
...
SELECT a.plugin_name                                                                              as plugin_name
     ...
     , sum(case when a.payment_transaction_status = 'SUCCESS' then a.converted_amount else 0 end) as converted_amount
     , a.converted_currency
FROM analytics_payment_purchases a FORCE INDEX(analytics_payment_purchases_created_date)
WHERE 1=1
  AND a.created_date
    >now() - interval '7' day
GROUP BY
...
SELECT a.plugin_name                                                                              as plugin_name
     ...
     , sum(case when a.payment_transaction_status = 'SUCCESS' then a.converted_amount else 0 end) as converted_amount
     , a.converted_currency
FROM analytics_payment_refunds a FORCE INDEX(analytics_payment_refunds_created_date)
WHERE 1=1
  AND a.created_date
    >now() - interval '7' day
GROUP BY
...
SELECT a.plugin_name                                                                              as plugin_name
     ...
     , sum(case when a.payment_transaction_status = 'SUCCESS' then a.converted_amount else 0 end) as converted_amount
     , a.converted_currency
FROM analytics_payment_voids a FORCE INDEX(analytics_payment_voids_created_date)
WHERE 1=1
  AND a.created_date
    >now() - interval '7' day
GROUP BY
...
create
or replace view v_report_payments_by_provider_sub2 as
select distinct plugin_name,
                ifnull(plugin_property_4, 'unknown') as merchant_account,
                ifnull(plugin_property_5, 'unknown') as payment_method,
                converted_currency,
                tenant_record_id
from analytics_payment_auths force index(analytics_payment_auths_date_trid_plugin_name)
...
select distinct plugin_name,
                ...
                converted_currency,
                tenant_record_id
from analytics_payment_captures force index(analytics_payment_captures_date_trid_plugin_name)
where created_date > now() - interval '7' day
union
select distinct plugin_name,
                ifnull(plugin_property_4, 'unknown') as merchant_account,
                ...
                converted_currency,
                tenant_record_id
from analytics_payment_chargebacks force index(analytics_payment_chargebacks_date_trid_plugin_name)
where created_date > now() - interval '7' day
union
select distinct plugin_name,
                ifnull(plugin_property_4, 'unknown') as merchant_account,
                ...
                converted_currency,
                tenant_record_id
from analytics_payment_credits force index(analytics_payment_credits_date_trid_plugin_name)
where created_date > now() - interval '7' day
union
select distinct plugin_name,
                ifnull(plugin_property_4, 'unknown') as merchant_account,
                ...
                converted_currency,
                tenant_record_id
from analytics_payment_purchases force index(analytics_payment_purchases_date_trid_plugin_name)
where created_date > now() - interval '7' day
union
select distinct plugin_name,
                ifnull(plugin_property_4, 'unknown') as merchant_account,
                ...
                converted_currency,
                tenant_record_id
from analytics_payment_refunds force index(analytics_payment_refunds_date_trid_plugin_name)
where created_date > now() - interval '7' day
union
select distinct plugin_name,
                ifnull(plugin_property_4, 'unknown') as merchant_account,
                ...
                converted_currency,
                tenant_record_id
from analytics_payment_voids force index(analytics_payment_voids_date_trid_plugin_name)
where created_date > now() - interval '7' day
;

-- PLUGIN DDL -> analytics-plugin -> v_report_payments_by_provider_sub3.ddl
create
or replace view v_report_payments_by_provider_sub3 as
select 1 as timeframe
union
select 2 as timeframe
union
select 3 as timeframe
union
...
create
or replace view v_report_payments_by_provider as
SELECT t1.plugin_name
     , t1.merchant_account
     , t1.payment_method
     , t1.tenant_record_id
     , t2.timeframe
     , transaction_type
     , case
           when t2.timeframe = 1 then 'Last 30 days'
     ...
     , case
           when failed is not null and total is not null then concat(round(((sum(failed) / sum(total)) * 100), 2), '%')
           else '0%'
    end                        as pct_failed
     , case
           when failed is not null and total is not null then concat(round(((sum(pending) / sum(total)) * 100), 2), '%')
           else '0%'
    end                        as pct_pending
     , case
           when failed is not null and total is not null then concat(round(((sum(good) / sum(total)) * 100), 2), '%')
           else '0%'
    end                        as pct_good
     , converted_amount
...
create
or replace view v_report_payments_by_provider_last_24h_summary as
select tenant_record_id
...
create table report_payments_by_provider_last_24h_summary as
select *
from v_report_payments_by_provider_last_24h_summary limit 0;
...
START TRANSACTION;
delete
from report_payments_by_provider_last_24h_summary;
insert into report_payments_by_provider_last_24h_summary
select *
from v_report_payments_by_provider_last_24h_summary;
COMMIT;
...
create table report_payments_by_provider_history as
select *
from v_report_payments_by_provider limit 0;
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
insert into report_payments_by_provider_history
select *
from v_report_payments_by_provider;
...
create
or replace view v_report_payment_provider_monitor_sub1 as
SELECT distinct apa.plugin_name
...
UNION
SELECT distinct app.plugin_name
...
create
or replace view v_report_payment_provider_monitor_sub2 as
SELECT apa.plugin_name
     , ifnull(apa.plugin_property_4, 'unknown') as                                 merchant_account
     , ifnull(apa.plugin_property_5, 'unknown') as                                 payment_method
     , apa.tenant_record_id
...
create
or replace view v_report_payment_provider_monitor_sub3 as
SELECT plugin_name
     , merchant_account
     , payment_method
     , tenant_record_id
...
create
or replace view v_report_payment_provider_monitor as
SELECT plugin_list.plugin_name
...
create table report_payment_provider_monitor_history as
select *
from v_report_payment_provider_monitor limit 0;
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
insert into report_payment_provider_monitor_history
select *
from v_report_payment_provider_monitor;
...
create
or replace view v_report_refunds_total_daily as
select ar.tenant_record_id
...
create table report_refunds_total_daily as
select *
from v_report_refunds_total_daily limit 0;
...
START TRANSACTION;
delete
from report_refunds_total_daily;
insert into report_refunds_total_daily
select *
from v_report_refunds_total_daily;
COMMIT;
...
create
or replace view v_report_invoices_daily as
select ai.tenant_record_id
...
create table report_invoices_daily as
select *
from v_report_invoices_daily limit 0;
...
START TRANSACTION;
delete
from report_invoices_daily;
insert into report_invoices_daily
select *
from v_report_invoices_daily;
COMMIT;
...
create
or replace view v_report_invoices_balance_daily as
select ai.tenant_record_id
     , date_format(ai.created_date, '%Y-%m-%d') as day
...
create table report_invoices_balance_daily as
select *
from v_report_invoices_balance_daily limit 0;
...
START TRANSACTION;
delete
from report_invoices_balance_daily;
insert into report_invoices_balance_daily
select *
from v_report_invoices_balance_daily;
COMMIT;
...
create
or replace view v_report_payment_provider_conversion_sub1 as
SELECT apa.plugin_name
     , ifnull(apa.plugin_property_4, 'unknown')                                    as merchant_account
     , ifnull(apa.plugin_property_5, 'unknown')                                    as payment_method
     , apa.tenant_record_id
...
WHERE 1 = 1
  ...
  AND cast(FROM_UNIXTIME(UNIX_TIMESTAMP(apa.created_date) - UNIX_TIMESTAMP(apa.created_date)%(15*60)) as time) =
      cast(FROM_UNIXTIME(UNIX_TIMESTAMP(NOW()) - 15 * 60 - (UNIX_TIMESTAMP(NOW()) - 15 * 60)%(15*60)) as time)
GROUP BY apa.plugin_name
       , ifnull(apa.plugin_property_4, 'unknown')
       , ifnull(apa.plugin_property_5, 'unknown')
       , apa.tenant_record_id
...
WHERE 1 = 1
  ...
  AND cast(FROM_UNIXTIME(UNIX_TIMESTAMP(app.created_date) - UNIX_TIMESTAMP(app.created_date)%(15*60)) as time) =
      cast(FROM_UNIXTIME(UNIX_TIMESTAMP(NOW()) - 15 * 60 - (UNIX_TIMESTAMP(NOW()) - 15 * 60)%(15*60)) as time)
GROUP BY app.plugin_name
       , ifnull(app.plugin_property_4, 'unknown')
       , ifnull(app.plugin_property_5, 'unknown')
...
create
or replace view v_report_payment_provider_conversion_sub2 as
SELECT apa.plugin_name
     , ifnull(apa.plugin_property_4, 'unknown')                                    as merchant_account
     , ifnull(apa.plugin_property_5, 'unknown')                                    as payment_method
     , apa.tenant_record_id
...
FROM analytics_payment_auths apa
WHERE 1 = 1
  AND apa.created_date < FROM_UNIXTIME(UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60 -
                                       (UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60)%(15*60) + 15*60)
  AND cast(FROM_UNIXTIME(UNIX_TIMESTAMP(apa.created_date) - UNIX_TIMESTAMP(apa.created_date)%(15*60)) as time) =
      cast(FROM_UNIXTIME(UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60 -
                         (UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60)%(15*60)) as time)
  AND apa.created_date >= FROM_UNIXTIME(UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60 -
                                        (UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60)%(15*60))
GROUP BY apa.plugin_name
       , ifnull(apa.plugin_property_4, 'unknown')
       , ifnull(apa.plugin_property_5, 'unknown')
       , apa.tenant_record_id
...
FROM analytics_payment_purchases app
WHERE 1 = 1
  AND app.created_date < FROM_UNIXTIME(UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60 -
                                       (UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60)%(15*60) + 15*60)
  AND cast(FROM_UNIXTIME(UNIX_TIMESTAMP(app.created_date) - UNIX_TIMESTAMP(app.created_date)%(15*60)) as time) =
      cast(FROM_UNIXTIME(UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60 -
                         (UNIX_TIMESTAMP(NOW() - interval '14' day) - 15 * 60)%(15*60)) as time)
...
create
or replace view v_report_payment_provider_conversion as
select rpccs1.plugin_name
     ...
     , case
           when current_success_count is not null and historical_success_count is not null
               then concat(round((((sum(rpccs1.current_success_count) - sum(rpccs2.historical_success_count)) /
                                   sum(rpccs2.historical_success_count)) * 100), 2), '%')
           else '0%'
    end                                                       success_delta
     , case
           when current_transaction_count is not null and historical_transaction_count is not null
               then concat(round((((sum(rpccs1.current_transaction_count) - sum(rpccs2.historical_transaction_count)) /
                                   sum(rpccs2.historical_transaction_count)) * 100), 2), '%')
           else '0%'
    end                                                       transaction_delta
     , case
           when current_customer_count is not null and historical_customer_count is not null
               then concat(round((((sum(rpccs1.current_customer_count) - sum(rpccs2.historical_customer_count)) /
                                   sum(rpccs2.historical_customer_count)) * 100), 2), '%')
           else '0%'
    end                                                       customer_delta
     , sysdate()                                           as refresh_date
...
create table report_payment_provider_conversion_history as
select *
from v_report_payment_provider_conversion limit 0;
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
insert into report_payment_provider_conversion_history
select *
from v_report_payment_provider_conversion;
...
create table report_conversions_total_dollar_monthly
(
    tenant_record_id int(11),
    day              date,
    term             varchar(50),
    count            int(10)
);
...
DELETE
FROM report_conversions_total_dollar_monthly;

create
temporary table report_temp_paid_bundles (index (bundle_id)) as
select distinct tenant_record_id
              , bundle_id
...
from
    analytics_subscription_transitions ast
    join report_temp_paid_bundles paid_bundles
on ast.bundle_id = paid_bundles.bundle_id and ast.tenant_record_id = paid_bundles.tenant_record_id
where 1=1
  and report_group='default'
  and next_service='entitlement-service'
...
create
or replace view v_report_cancellations_daily as
select ast.tenant_record_id
...
create table report_cancellations_daily as
select *
from v_report_cancellations_daily limit 0;
...
START TRANSACTION;
delete
from report_cancellations_daily;
insert into report_cancellations_daily
select *
from v_report_cancellations_daily;
COMMIT;
...
create
or replace view v_report_accounts_summary as
select a.tenant_record_id
...
create table report_accounts_summary as
select *
from v_report_accounts_summary limit 0;
...
START TRANSACTION;
delete
from report_accounts_summary;
insert into report_accounts_summary
select *
from v_report_accounts_summary;
COMMIT;
...
create
or replace view v_report_mrr_daily as
select ast.tenant_record_id
...
from
    calendar cal
    left join analytics_subscription_transitions ast
on cast (date_format(ast.next_start_date, '%Y-%m-%d') as date) <= cast (date_format(cal.d, '%Y-%m-%d') as date)
    and case when ast.next_end_date is not null then ast.next_end_date > cast (date_format(cal.d, '%Y-%m-%d') as date) else 1=1
end
where 1=1
  and cal.d <= now()
  and ast.report_group='default'
...
create table report_mrr_daily as
select *
from v_report_mrr_daily limit 0;
...
START TRANSACTION;
delete
from report_mrr_daily;
insert into report_mrr_daily
select *
from v_report_mrr_daily;
COMMIT;
...
create
or replace view v_report_payment_provider_errors_sub1 as
select aa.tenant_record_id
     , 'AUTH' as op
     , date_format(aa.created_date, '%Y-%m-%d') as day
, aa.currency
...
where 1=1
  and aa.payment_transaction_status not in ('PENDING'
    , 'SUCCESS')
  and aa.report_group = 'default'
  and aa.created_date
    > now() - interval '60' day
...
from analytics_payment_purchases ap
where 1=1
  and ap.payment_transaction_status not in ('PENDING'
    , 'SUCCESS')
  and ap.report_group = 'default'
  and ap.created_date
    > now() - interval '60' day
...
create
or replace view v_report_payment_provider_errors_sub2 as
select v1.tenant_record_id
     , v1.day
     , v1.currency
     , v1.plugin_name
...
from v_report_payment_provider_errors_sub1 v1
    left join analytics_payment_auths apa
on apa.record_id = v1.record_id and v1.op = 'AUTH'
    left join analytics_payment_purchases app on app.record_id = v1.record_id and v1.op = 'PURCHASE'
where 1=1
  and ifnull(apa.plugin_gateway_error
    , app.plugin_gateway_error) is not null
group by 1, 2, 3, 4, 5
;

-- PLUGIN DDL -> analytics-plugin -> v_report_payment_provider_errors.ddl
create
or replace view v_report_payment_provider_errors as
select tenant_record_id
     , day
     , currency
     , plugin_name
...
create table report_payment_provider_errors_sub2 as
select *
from v_report_payment_provider_errors_sub2 limit 0;
create table report_payment_provider_errors as
select *
from v_report_payment_provider_errors limit 0;
...
START TRANSACTION;
delete
from report_payment_provider_errors_sub2;
insert into report_payment_provider_errors_sub2
select *
from v_report_payment_provider_errors_sub2;

delete
from report_payment_provider_errors;
...
create table report_churn_total_usd_monthly
(
    tenant_record_id int(11),
    day              date,
    term             varchar(50),
...
create table report_churn_percent_monthly
(
    tenant_record_id int(11),
    day              date,
    term             varchar(50),
...
BEGIN
    ...
    create
temporary table report_temp_churn_monthly_paid_bundles (index (bundle_id)) as
select distinct tenant_record_id
              , bundle_id
from analytics_invoice_items
where 1 = 1
...
create
temporary table report_temp_churn_monthly_paid_bundles2 (index (bundle_id)) as
select distinct tenant_record_id
              , bundle_id
from analytics_invoice_items
where 1 = 1
...
create
temporary table report_temp_churn_monthly_dollars_pct_monthly as
select active_sub_dollar.tenant_record_id
...
from (select ast.tenant_record_id
      ...
      group by 1, 2, 3) churn_dollar
         join (select ast.tenant_record_id
                    , cal.d month
                    , next_billing_period
                    , sum(converted_next_price) amount
               from analytics_subscription_transitions ast
                        join calendar cal
                             on next_start_date < cal.d and (next_end_date > cal.d or next_end_date is null) and
                                (cal.d = date_format(cal.d, '%Y-%m-01')) and cal.d >= '2013-01-01' and cal.d < sysdate()
                        join report_temp_churn_monthly_paid_bundles2 paid_bundles
                             on ast.bundle_id = paid_bundles.bundle_id and
                                ast.tenant_record_id = paid_bundles.tenant_record_id
               where 1 = 1
                 and report_group = 'default'
                 and next_service = 'entitlement-service'
                 and event not like 'STOP_ENTITLEMENT%'
                 and next_billing_period in ('MONTHLY')
               group by 1, 2, 3) active_sub_dollar on churn_dollar.month = active_sub_dollar.month and
                                                      churn_dollar.prev_billing_period =
                                                      active_sub_dollar.next_billing_period and
                                                      churn_dollar.tenant_record_id = active_sub_dollar.tenant_record_id
;

DELETE
FROM report_churn_total_usd_monthly;
DELETE
FROM report_churn_percent_monthly;
...
create
temporary table report_temp_churn_annual_paid_bundles (index (bundle_id)) as
select distinct tenant_record_id
              , bundle_id
from (select tenant_record_id
           , bundle_id
      from analytics_invoice_items
      where 1 = 1
        and invoice_original_amount_charged > 0
        and invoice_balance = 0
      union
      select s.tenant_record_id
           , s.bundle_id
      from subscription_events se
               join subscriptions s on se.subscription_id = s.id and se.tenant_record_id = s.tenant_record_id
      where 1 = 1
        and user_type in ('MIGRATE_ENTITLEMENT')) bundles
;


create
temporary table report_temp_churn_annual_paid_bundles2 (index (bundle_id)) as
select distinct tenant_record_id
              , bundle_id
...
create
temporary table report_temp_churn_annual_dollars_pct_monthly as
select churn_dollar.tenant_record_id
     , churn_dollar.month
...
from (select ast.tenant_record_id
      ...
      from analytics_subscription_transitions ast
               join report_temp_churn_annual_paid_bundles paid_bundles
                    on ast.bundle_id = paid_bundles.bundle_id and ast.tenant_record_id = paid_bundles.tenant_record_id
      where 1 = 1
        and report_group = 'default'
        and next_service = 'entitlement-service'
         ...
         join (select ast.tenant_record_id
               ...
               from analytics_subscription_transitions ast
                        join calendar cal
                             on next_start_date < cal.d and (next_end_date > cal.d or next_end_date is null) and
                                (cal.d = date_format(cal.d, '%Y-%m-01')) and cal.d >= '2013-01-01' and cal.d < sysdate()
                        join report_temp_churn_annual_paid_bundles2 paid_bundles
                             on ast.bundle_id = paid_bundles.bundle_id and
                                ast.tenant_record_id = paid_bundles.tenant_record_id
               where 1 = 1
                 and report_group = 'default'
