...
-- PLUGIN DDL -> payment-test-plugin
use killbill
drop table if exists testpayment_hpp_requests;
drop table if exists testpayment_responses;
drop table if exists testpayment_payment_methods;

-- PLUGIN DDL -> payment-test-plugin -> ddl.sql
