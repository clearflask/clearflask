...
aws s3 cp s3://clearflask-secret/connect.config.js /opt/clearflask/connect.config.js &
wait
...
chmod go-rwx /opt/clearflask/connect.config.js
chown connect:connect /opt/clearflask/connect.config.js
