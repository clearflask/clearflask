...
**Fees for Paid Services.** Some of our Services are offered for a fee, such as ClearFlask.com plans (collectively, "Paid Services"). By using a Paid Service, you agree to pay the specified fees (for example, [ClearFlask fees](https://ClearFlask.com/)). Depending on the Paid Service, there may be one-time fees, recurring fees, or revenue-based fees. For recurring fees, we’ll bill or charge you for in regular automatically-renewing intervals (such as monthly, annually, or biennially), on a pre-pay basis until you cancel, which you can do at any time by contacting the relevant support team. For revenue-based fees you pay us a percentage of the revenue your website generates. Revenue-based fees are ongoing. 
...
**Attribution.** We reserve the right to display attribution text or links in your Platform, attributing ClearFlask.com. Some of these attributions may not be altered or removed.
